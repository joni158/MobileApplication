...
public class TrapesiumActivity extends Activity {

	EditText editSisi1, editSisi2, editSisi3, editSisi4, editJmlSisi, editTinggi;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editJmlSisi = (EditText) findViewById(R.id.editTextJmlSisi);
		...
		tombolLuas.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				double jmlSisi = Double.parseDouble(
						editJmlSisi.getText().toString());
				double tinggi = Double.parseDouble(
						editTinggi.getText().toString());;
				
				double Luas = 0.5 * jmlSisi * tinggi;
